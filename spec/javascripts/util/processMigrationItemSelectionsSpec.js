(function() {
  ...
  require(['compiled/util/processMigrationItemSelections'], function(processMigrationItemSelections) {
    var data;
    ...
    test('change hash of hashes to hash of lists', function() {
      var newData;
    ...
    return test('remove individual selections if copy everything is selected', function() {
      var newData;
