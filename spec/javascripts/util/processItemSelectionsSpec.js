(function() {
  ...
  require(['compiled/util/processItemSelections'], function(processItemSelections) {
    module("processItemSelections");
    return test('move hash of selected items to list of selected', function() {
      var data, newData;
      data = {
      ...
      return deepEqual(newData, {
        "items_to_copy": ["all_assignments", "all_external_tools", "all_files", "assignment_group_552", "attachment_6949", "context_external_tool_253", "course_settings", "folder_1564", "shift_dates"],
        "authenticity_token": "watup=",
        "copy[course_id]": "132",
        "copy[day_substitutions][0]": "0",
        "copy[new_end_date]": "",
